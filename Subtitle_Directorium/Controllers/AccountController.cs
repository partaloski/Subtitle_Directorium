...
namespace Subtitle_Directorium.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddUserToRole()
        {
            ...
            model.roles = new List<string> { "Admin", "User", "Editor", "Submittor" };
            return View(model);
        }
        [HttpPost]
        public ActionResult AddUserToRole(AddToRoleModel model)
        {
            ...
            if(user == null)
            {
                throw new HttpException(404, "No user with the email provided.");
            }
        ...
        [HttpPost]
        public ActionResult RequestUserAccess(AddToRoleModel model)
        {
            model.Email = User.Identity.Name;
            var email = model.Email;
            var user = UserManager.FindByEmail(email);
        ...
        public ActionResult ApproveUser(int ? id)
        {
            ...
            Subtitle_Directorium.Models.AddToRoleModel model = db.UserRequests.Find(id);
